...
const testimonials = [
  {
    ...
    quote:
      "HyperZones has transformed how our global team coordinates. It's become an essential tool for our daily operations.",
  },
  {
    name: "James Wilson",
    role: "Digital Nomad",
    ...
    quote:
      "The intuitive interface and offline functionality make it perfect for my traveling lifestyle.",
  },
  {
    ...
    quote:
      "Finally, a time zone app that's both beautiful and functional. The sunlight slider is genius!",
  },
];
