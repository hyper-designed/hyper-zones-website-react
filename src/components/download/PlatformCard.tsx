...
import { Apple, Windows, Chrome, Smartphone, Globe, Launch } from '../icons';
...
export function PlatformCard({ platform, featured = false }: PlatformCardProps) {
      ...
      <div className={`${featured ? 'max-w-[400px] mx-auto' : 'w-full'}`}>
        ...
        `}>
          ...
          <div className="relative z-10">
            {/* Header */}
            <div className="mb-6">
              <p className="text-sm text-white/80 mb-1">{platform.deviceTypes}</p>
              <h3 className={`
